...
public class HoroscopeLab {
    ...
    private HoroscopeLab(){
        ...
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.com, R.color.com_color, R.raw.ic_com, R.drawable.bac_com, "com"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.ero, R.color.ero_color, R.raw.ic_ero, R.drawable.bac_erotic, "ero"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.lov, R.color.love_color, R.raw.ic_lov, R.drawable.bac_love, "lov"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.bus, R.color.bus_color, R.raw.ic_bus, R.drawable.bac_bus, "bus"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.hea, R.color.hea_color, R.raw.ic_hea, R.drawable.bac_hea, "hea"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.cook, R.color.cook_color, R.raw.ic_cook, R.drawable.bac_cook, "cook"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.mob, R.color.mob_color, R.raw.ic_mob, R.drawable.bac_mob, "mob"));
        mAllHoroscopesConfig.add(new OneHoroscopeInfo(R.string.anti, R.color.anti_color, R.raw.ic_anti, R.drawable.bac_anti, "anti"));
    }
